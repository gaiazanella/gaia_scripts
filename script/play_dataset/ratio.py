...
duration_stats = filtered_data['Ratio'].describe()
median_duration = filtered_data['Ratio'].median()
quartiles = filtered_data['Ratio'].quantile([0.25, 0.5, 0.75])
...
plt.hist(filtered_data['Ratio'], bins=50, color='skyblue', edgecolor='black', alpha=0.7)
plt.xlabel('Ratio Value', fontsize=18)  # Taille de la police de l'axe X
...
print("Statistical Distribution of 'Ratio':")
