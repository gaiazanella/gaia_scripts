...
automatic_data = pd.read_csv('/home/gaia/Documents/processing_1_sec/2020/double_duration_speed_strg_stra/strg_stra_all_peaks_data.csv')
...
for ratio_seuil in ratio_thresholds:
    for rsam_seuil in rsam_thresholds:
        ...
        filtred_detections = automatic_data[
            ...
            (automatic_data['RSAM_G'] > rsam_seuil)
        ]
