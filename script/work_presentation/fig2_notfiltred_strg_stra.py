...
st3 = client.get_waveforms(network=net[1], station=stz[2], location="", channel=channel[1], starttime=ti, endtime=tf)
...
data3_low = bandpass(st3[0].data, freqmin=0.03, freqmax=1, df=fs, corners=4, zerophase=True)
