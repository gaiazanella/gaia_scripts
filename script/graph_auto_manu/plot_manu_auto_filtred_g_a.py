...
if 'RSAM_G' not in data.columns or 'Ratio' not in data.columns:
    raise ValueError("The columns 'RSAM_E' and/or 'Ratio' are missing in the loaded file.")

filtered_data = data[(data['RSAM_G'] > 150) & (data['Ratio'] < 2.5)]

# Extraire la date sans l'heure de la colonne 'Peak_Time_UTC'
if 'Peak_Time_UTC' not in filtered_data.columns:
    raise ValueError("The column 'Peak_Time_UTC' is missing in the filtered data.")
...
auto_output_path = '/home/gaia/Documents/2020_auto_strg_stra_1sec_filtered.csv'
...
if 'Date' not in result_auto.columns or 'frane' not in result_auto.columns:
    raise ValueError("The columns 'Date' and/or 'frane' are missing in the file '2020_auto_strg_stra_1sec_filtered.csv'.")
...
save_path = '/home/gaia/Documents/processing_1_sec/2020/landslide_comparison_filtered.jpg'
