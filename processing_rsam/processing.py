...
for j in range(len(stz)):  # Cette boucle sera maintenant exécutée une seule fois, car stz ne contient que 'STRG'
    ...
    for i in range(len(th_day) - 1): 
        ...
        # Parcourir chaque multiple de 10 ou 1 secondes de la période
        current_time = start_time 
        while current_time < end_time:
            window_start = current_time - 5  # 5 ou 0.5 secondes avant la seconde exacte
            window_end = current_time + 5  # 5 ou 0.5 secondes après la seconde exacte
            ...
            current_time += 10  # Incrémenter de 10 ou 1 secondes
