...
def process_data(file_E, file_G, output_file):
    ...
    df_ratio['ratio_8_15Hz'] = df_G['RSAM_env_smooth_8-15Hz'] / df_E['RSAM_env_smooth_8-15Hz']
...
for single_date in pd.date_range(start_date, end_date):
    ...
    chemin_vers_les_fichiers_E = f'/home/gaia/Documents/processing_1_sec/2020/rsam/rsam_STRE_{date_str}*.csv'
