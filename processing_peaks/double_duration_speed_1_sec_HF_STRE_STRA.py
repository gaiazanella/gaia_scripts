...
def process_data(file_A, file_E, output_file):
    ...
    df_ratio['ratio_8_15Hz'] = df_E['RSAM_env_smooth_8-15Hz'] / df_A['RSAM_env_smooth_8-15Hz']
    ...
    peaks_df = pd.DataFrame({
        ...
        'RSAM_E': df_E['RSAM_env_smooth_8-15Hz'].iloc[peaks_8_15Hz].values,
        'Duration': durations,
...
for single_date in pd.date_range(start_date, end_date):
    ...
    chemin_vers_les_fichiers_A = f'/home/gaia/Documents/processing_1_sec/2021/rsam/rsam_STRA_{date_str}*.csv'
    chemin_vers_les_fichiers_E = f'/home/gaia/Documents/processing_1_sec/2021/rsam/rsam_STRE_{date_str}*.csv'
