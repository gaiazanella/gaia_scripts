...
output_dir = '/home/gaia/Documents/processing_10_sec/2020/double_duration_speed_stre_stra_test'  # Répertoire de sortie
...
for single_date in pd.date_range(start_date, end_date):
    ...
    if fichiers_A and fichiers_G:
        output_file = os.path.join(output_dir, f'stre_stra_peaks_data_{date_str}.csv')
        process_data(fichiers_A[0], fichiers_G[0], output_file)

# Combiner tous les fichiers CSV résultants en un seul fichier
all_files = glob.glob(os.path.join(output_dir, "stre_stra_peaks_data_*.csv"))
...
if dataframes:  # Vérifiez si la liste n'est pas vide
    ...
    combined_output_file = os.path.join(output_dir, 'stre_stra_all_peaks_data.csv')
