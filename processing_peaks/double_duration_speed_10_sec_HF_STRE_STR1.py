...
output_dir = '/home/gaia/Documents/processing_10_sec/2020/double_duration_speed_stre_str1_test'  # Répertoire de sortie
...
def process_data(file_A, file_G, output_file):
    ...
    peaks_df = pd.DataFrame({
        ...
        'Ratio': ratio,
        'RSAM_1': df_A['RSAM_env_smooth_8-15Hz'].iloc[peaks_8_15Hz].values,
        'RSAM_E': df_G['RSAM_env_smooth_8-15Hz'].iloc[peaks_8_15Hz].values,
        'Duration': durations,
...
for single_date in pd.date_range(start_date, end_date):
    ...
    chemin_vers_les_fichiers_A = f'/home/gaia/Documents/processing_10_sec/2020/rsam_test/rsam_STR1_{date_str}*.csv'
    chemin_vers_les_fichiers_G = f'/home/gaia/Documents/processing_10_sec/2020/rsam_test/rsam_STRE_{date_str}*.csv'
    ...
    if fichiers_A and fichiers_G:
        output_file = os.path.join(output_dir, f'stre_str1_peaks_data_{date_str}.csv')
        process_data(fichiers_A[0], fichiers_G[0], output_file)

# Combiner tous les fichiers CSV résultants en un seul fichier
all_files = glob.glob(os.path.join(output_dir, "stre_str1_peaks_data_*.csv"))
...
if dataframes:  # Vérifiez si la liste n'est pas vide
    ...
    combined_output_file = os.path.join(output_dir, 'stre_str1_all_peaks_data.csv')
